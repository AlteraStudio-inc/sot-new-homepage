    ...
    return (
        <div className="w-full bg-[#FAF9F5] min-h-screen text-[#2C3E35] overflow-hidden">
            <div className="bg-[#E8F0E4] py-16 md:py-24 text-center relative overflow-hidden">
                <div className="absolute bottom-10 right-10 z-0 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                    <Bird className="text-[#38A182] w-12 h-12 opacity-80 mix-blend-multiply -rotate-12 transform scale-x-[-1]" />
                </div>
                <h1 className="text-3xl md:text-4xl font-bold text-[#2C3E35] mb-4 animate-fade-in-up">よくあるご質問</h1>
                <p className="text-[#556b5d] animate-fade-in-up" style={{ animationDelay: '100ms' }}>患者様から多く寄せられる質問にお答えします。</p>
            </div>

            <div className="container mx-auto px-4 max-w-3xl py-16 md:py-24">
                <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-[#E8F0E4] animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                    {faqs.length > 0 ? (
