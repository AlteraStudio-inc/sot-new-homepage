    ...
    return (
        <div className="w-full bg-[#FAF9F5] min-h-screen text-[#2C3E35]">
            <div className="bg-[#E8F0E4] py-16 md:py-24 text-center relative overflow-hidden">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-[#2C3E35] mb-4">施術案内</h1>
                <p className="text-[#556b5d]">当院の独自の施術アプローチについて</p>
            </div>

            <div className="container mx-auto px-4 max-w-4xl py-16 md:py-24 space-y-16">

                {/* 脳幹療法 */}
                <section className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-[#E8F0E4]">
                ...
                {/* メンタルセラピー */}
                <section className="bg-[#E8F0E4] rounded-[2rem] p-8 md:p-12 shadow-sm border border-[#d2e0cc]">
